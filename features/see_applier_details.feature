Feature: See applier details

As a requester
So that I can determine which carrier to choose
I want to see historical reviews of carriers

Background: carriers have historical reviews
...
| 1   | first request       |1            | 1              |      2      |2020-03-06 00:00:00      |2020-03-06 00:00:00    | 1      |
    ...
    Given the following requestes exist:
        ...
        | 2   | finished request       |1            |2        | 1              |      2      |2020-03-06 00:00:00      |2020-03-06 00:00:00    | 7      |
...
|  1   |    1        |  2        |
    ...
    Scenario: Requester see historical reviews of carriers
