Feature: Add reviews for carrier

  As a requester
  So that I can convey my attitudes to this order
  I want to add ratings or comments to the carrier

  Background: carriers have done his job
    ...
    Given the following requestes exist:
      ...
      | 2   | second request       |1            |2        | 1              |      2      |2020-03-06 00:00:00      |2020-03-06 00:00:00    | 5      |

    Given the following requestes exist:
      | id  | title               |requester_id |source_addr_id | dest_addr_id| expected_delivery_start | expected_delivery_end | status |
      | 3   | pending request       |1          | 1              |      2      |2020-03-06 00:00:00      |2020-03-06 00:00:00    | 1     |
  ...
  Scenario: Confirm order arrival and add reviews for carrier
    ...
    Then I follow "Confirm arrival"
    Then I should see "Rate this carrier"
    Then I follow "Rate this carrier"
    Then I should see "Rate this carrier for this order"
    When I select "Good" from "score"
    When I fill in "comment" with "perfect"
    Then I press "Rate this carrier"
    Then I should see "User Center"
    Then I follow "Pick a carrier"
    Then I should see "Current applications"
    Then I follow "2"
    Then I should see "perfect"
